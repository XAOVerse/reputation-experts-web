...
const DENTAL_FAQ = [
  {
    ...
    answer:
      "We monitor your Google Business Profile and other platforms around the clock. The moment a new harmful review appears, our team is alerted and processes the removal, if the review can not be taken down, we craft professional responses on your behalf that show prospective clients your venue takes feedback seriously. You're never caught off guard by a review again.",
  },
  {
    question: "How long does it take to see results for my event venue?",
    answer:
