...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for UK event venues. Every strategy is shaped around how event planners actually search for and choose their venue online.",
  tags = DEFAULT_TAGS,
