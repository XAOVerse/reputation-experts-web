...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for UK laser eye surgery clinics. Every strategy is shaped around how patients actually search for and choose their laser eye surgeon online.",
  tags = DEFAULT_TAGS,
