...
export function ProblemStatementSection({
  heading,
  bodyLeft = "In 2026, Over 85% of buyers and tenants read online reviews before choosing an estate agent or letting agent. Reputation directly drives revenue. A practice with a poor online reputation loses clients to competitors every single day, even when the clinical care is identical. We close that gap by removing damaging reviews that drag your rating down and generating a consistent flow of new 5-star reviews that strengthen trust and push your rating up.",
  bodyRight = "We also help ensure your agency appears prominently when potential clients search on Google, ask ChatGPT, or browse AI Overviews. The result is more visibility, more clicks, more calls, and more booked appointments. Clients typically see a 30\u201350% increase in new client enquiries within the first three months.",
