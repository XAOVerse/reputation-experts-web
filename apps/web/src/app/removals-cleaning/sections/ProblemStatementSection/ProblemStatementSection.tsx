...
export function ProblemStatementSection({
  heading,
  bodyLeft = "In 2026, Over 80% of customers read online reviews before hiring a removal company or cleaning service. Reputation directly drives revenue. A practice with a poor online reputation loses customers to competitors every single day, even when the clinical care is identical. We close that gap by removing damaging reviews that drag your rating down and generating a consistent flow of new 5-star reviews that strengthen trust and push your rating up.",
    ...
    >
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-10">
        ...
        >
          {heading ?? (
            <>
              For many UK removals and cleaning businesses,{" "}
