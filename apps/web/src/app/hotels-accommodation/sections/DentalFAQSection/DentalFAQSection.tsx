...
const DENTAL_FAQ = [
  ...
  {
    question: "How does Google's AI Overview affect my hotel?",
    answer:
      "Google's AI Overviews now pull together information from reviews, your website, and third-party sources into a single AI-generated answer at the top of the search results. When someone searches for terms like \"best hotel near me\", Google no longer just shows a list of websites; it increasingly highlights and recommends specific hotels. Reputation Experts strengthens your entire digital presence so your property is in a far better position to be trusted and recommended by Google's AI. This includes improving your review profile, increasing rating strength and review volume, optimising trust signals across your web presence, and building authority through high-quality third-party coverage. When your hotel is featured in trusted media and reputable publications — something we specialise in — it creates the kind of authority signals that naturally improve how your property is understood and recommended by Google AI Overviews, ChatGPT, and other AI-driven discovery platforms.",
  },
  {
    question: "How does Reputation Experts build a strong online reputation for my hotel?",
    answer:
      "We work across three phases. First, we clean up, removing policy-violating reviews, suppressing negative search results, and fixing gaps in your Google Business Profile. Second, we strengthen, building a steady flow of genuine 5-star reviews from your existing guests using follow-up systems timed around bookings, and publishing authoritative content that positions your property as a trusted name online. Third, we establish long-term authority, securing press coverage, optimising for Google AI Overviews and ChatGPT recommendations, and providing ongoing monitoring so your reputation stays protected month after month.",
  },
  {
    question: "How does Reputation Experts help clinics boost their bookings and increase sales?",
    answer:
      "Reputation directly drives revenue. 87% of customers check online reviews before making an appointment (unless existing clients). A practice sitting at lower score stars loses guests to a competitor at a higher score every single day, even if the clinical care is identical. We close that gap by removing unfair reviews that drag your rating down, generating a consistent stream of new 5-star reviews that push it up, and ensuring your property appears prominently when potential guests search on Google, ask ChatGPT, or browse AI Overviews. The result is more clicks, more calls, and more bookings, clients typically see a 30–50% increase in new guest enquiries within the first three months.",
  },
];
