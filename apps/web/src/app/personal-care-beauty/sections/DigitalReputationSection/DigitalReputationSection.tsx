...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for UK personal care and beauty businesses. Every strategy is shaped around how clients actually search for and choose their salon or barber online.",
  tags = DEFAULT_TAGS,
