...
const DENTAL_FAQ = [
  ...
  {
    question: "How long does it take to see results for my personal care or beauty business?",
    answer:
  ...
  {
    question: "How does Google's AI Overview affect my personal care or beauty business?",
    answer:
