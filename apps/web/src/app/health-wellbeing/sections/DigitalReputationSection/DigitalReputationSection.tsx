...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for UK health and wellbeing practices. Every strategy is shaped around how patients actually search for and choose their health practitioner online.",
  tags = DEFAULT_TAGS,
