...
const DENTAL_FAQ = [
  ...
  {
    question: "How long does it take to see results for my health and wellbeing practice?",
    answer:
  ...
  {
    question: "How does Google's AI Overview affect my health and wellbeing practice?",
    answer:
      "Google's AI Overviews now pull together information from reviews, your website, and third-party sources into a single AI-generated answer at the top of the search results. When someone searches for terms like \"best physiotherapist near me\", Google no longer just shows a list of websites; it increasingly highlights and recommends specific practices. Reputation Experts strengthens your entire digital presence so your practice is in a far better position to be trusted and recommended by Google's AI. This includes improving your review profile, increasing rating strength and review volume, optimising trust signals across your web presence, and building authority through high-quality third-party coverage. When your health and wellbeing practice is featured in trusted media and reputable publications — something we specialise in — it creates the kind of authority signals that naturally improve how your practice is understood and recommended by Google AI Overviews, ChatGPT, and other AI-driven discovery platforms.",
  },
  {
