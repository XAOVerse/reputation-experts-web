...
const DENTAL_FAQ = [
  {
    ...
    answer:
      "We monitor your Google Business Profile and other platforms around the clock. The moment a new harmful review appears, our team is alerted and processes the removal, if the review can not be taken down, we craft professional responses on your behalf that show prospective parents your business takes feedback seriously. You're never caught off guard by a review again.",
  },
  {
    question: "How long does it take to see results for my childcare or education business?",
    answer:
  ...
  {
    question: "How does Google's AI Overview affect my childcare or education business?",
    answer:
      "Google's AI Overviews now pull together information from reviews, your website, and third-party sources into a single AI-generated answer at the top of the search results. When someone searches for terms like \"best nursery near me\", Google no longer just shows a list of websites; it increasingly highlights and recommends specific businesses. Reputation Experts strengthens your entire digital presence so your business is in a far better position to be trusted and recommended by Google's AI. This includes improving your review profile, increasing rating strength and review volume, optimising trust signals across your web presence, and building authority through high-quality third-party coverage. When your childcare or education business is featured in trusted media and reputable publications — something we specialise in — it creates the kind of authority signals that naturally improve how your business is understood and recommended by Google AI Overviews, ChatGPT, and other AI-driven discovery platforms.",
  },
  {
    question: "How does Reputation Experts build a strong online reputation for my business?",
    answer:
      "We work across three phases. First, we clean up, removing policy-violating reviews, suppressing negative search results, and fixing gaps in your Google Business Profile. Second, we strengthen, building a steady flow of genuine 5-star reviews from your existing parents using follow-up systems timed around enquiries, and publishing authoritative content that positions your business as a trusted name online. Third, we establish long-term authority, securing press coverage, optimising for Google AI Overviews and ChatGPT recommendations, and providing ongoing monitoring so your reputation stays protected month after month.",
  },
  {
    question: "How does Reputation Experts help clinics boost their bookings and increase sales?",
    answer:
      "Reputation directly drives revenue. 87% of customers check online reviews before making an appointment (unless existing clients). A practice sitting at lower score stars loses parents to a competitor at a higher score every single day, even if the clinical care is identical. We close that gap by removing unfair reviews that drag your rating down, generating a consistent stream of new 5-star reviews that push it up, and ensuring your business appears prominently when potential parents search on Google, ask ChatGPT, or browse AI Overviews. The result is more clicks, more calls, and more enrolment enquiries, clients typically see a 30–50% increase in new parent enquiries within the first three months.",
  },
];
