...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for UK childcare and education businesses. Every strategy is shaped around how parents actually search for and choose their childcare provider online.",
  tags = DEFAULT_TAGS,
