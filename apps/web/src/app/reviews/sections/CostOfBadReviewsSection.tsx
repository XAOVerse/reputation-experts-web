  ...
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-10">
        ...
        <p className="text-[#444] text-[16px] lg:text-[17px] leading-[1.65] max-w-[820px] mb-10 lg:mb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6">
          {COSTS.map((c) => (
            ...
            >
              <h3 className="text-[#1a1a1a] text-[17px] lg:text-[18px] font-semibold leading-[1.3] mb-3">
                {c.title}
              </h3>
