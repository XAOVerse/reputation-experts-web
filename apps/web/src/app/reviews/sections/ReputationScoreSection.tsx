    ...
    >
      <div className="max-w-[1280px] mx-auto px-5 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          {/* Heading column — narrow, with intro */}
          <div className="lg:col-span-3">
            ...
            <p className="text-[#555] text-[15px] leading-[1.7]">
              One score per location, updated weekly. You see what is lifting
              you and what is dragging you down at a glance.
            </p>
          </div>
        ...
        {/* Two outcomes below — orange uppercase tracked titles */}
        <div className="mt-10 lg:mt-14 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8 lg:gap-x-14 lg:gap-y-10">
          ...
          <div>
            ...
            <p className="text-[#555] text-[14.5px] sm:text-[15px] leading-[1.7]">
              ...
              vanity metrics, no slides padding out the deck, just the work that
              changes the number.
            </p>
          </div>
        </div>
