...
export function DigitalReputationSection({
  ...
  description = "Our approach brings together review management, reputation building, Google AI Overview optimisation, ChatGPT recommendation positioning, and major online media publications - all in one integrated service built specifically for UK takeaway and food retail businesses. Every strategy is shaped around how customers actually search for and choose their takeaway or food shop online.",
  tags = DEFAULT_TAGS,
